    ...
    const fetchData = async () => {
      try {
        ...
        const [buildings, floors, rooms, tenants] = await Promise.all([
          apiRequest({ endpoint: "/buildings/getBuildings", method: "GET", navigate }),
          apiRequest({ endpoint: "/floors/getFloors", method: "GET", navigate }),
          apiRequest({ endpoint: "/rooms/getRooms", method: "GET", navigate }),
          apiRequest({ endpoint: "/tenants/getTenants", method: "GET", navigate }),
        ]);
